...
const val CHANNEL_ID = "studyflow_reminder"
const val CHANNEL_NAME = "Study Reminders"
const val NOTIFICATION_ID = 1001
const val REMINDER_PENDING_INTENT = 2001
const val SESSION_CHANNEL_ID = "studyflow_sessions"
...
fun createNotificationChannel(context: Context) {
    ...
    val sessionChannel = NotificationChannel(
        ...
        description = "Session complete notifications"
        enableVibration(true)
    }
...
fun showStudyReminderNotification(context: Context) {
    ...
    val notification = NotificationCompat.Builder(context, CHANNEL_ID)
        ...
        .setContentTitle("Ready to Study?")
        .setContentText("Your StudyFlow session is waiting. Stay consistent!")
